...
BUILDOPTS = ['GameLoop', 'Uart', 'Camera', 'Projector', 'ColorPicker', 'BuildTest', 'Table', 'DropShot']
...
BUILDDICT['Table'] = {
    'defs': ['TESTTABLE'],
    'source': [BUILDDIR+'CameraInterface.cpp',BUILDDIR+'Table.cpp',BUILDDIR+'ColorTracker.cpp',BUILDDIR+'ContourTracker.cpp',BUILDDIR+'Projector.cpp', BUILDDIR+'UartDecoder.cpp']
    }
BUILDDICT['DropShot'] = {
    'defs': ['TESTDROPSHOT'],
    'source': [BUILDDIR+'CameraInterface.cpp',BUILDDIR+'Table.cpp',BUILDDIR+'ColorTracker.cpp',BUILDDIR+'ContourTracker.cpp',BUILDDIR+'Projector.cpp', BUILDDIR+'UartDecoder.cpp', BUILDDIR+'DropShot.cpp']
    }
...
if CLEAN:
    ...
    print('Options:', list(BUILDDICT.keys()))
    exit()
else:
